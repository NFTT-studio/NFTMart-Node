...
// 			sp_core::crypto::Ss58AddressFormat::Custom(node_runtime::SS58Prefix::get() as u16)
// 		);
...
// 		let alice = MultiSigner::from(Alice.public()).into_account();
//
// 		let p = Properties(<BitFlags<ClassProperty>>::from_bits(7).unwrap());
//
// 		node.submit_extrinsic(nftmart_nft::Call::create_class(
// 			(b"hello world1").to_vec(),
// 			(b"hello world2").to_vec(),
// 			(b"hello world3").to_vec(),
// 			p
// 		), alice);
// 		node.seal_blocks(1);
//
